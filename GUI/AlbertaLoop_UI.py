...
# Launch button commented out for kdays
...
"")
        ...
        self.safeBtn = QtWidgets.QPushButton(self.main_frame)
        self.safeBtn.setGeometry(QtCore.QRect(920, 90, 205, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(9)
        self.safeBtn.setFont(font)
        self.safeBtn.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.safeBtn.setStyleSheet("background-color: rgb(170, 85, 255);\n"
"color: rgb(0, 0. 0);\n"
"font: 75 9pt \"Arial\";\n"
"")
        self.safeBtn.setObjectName("safeBtn")
...
"selection-background-color: rgb(197, 197, 197);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.safeBtn.setText(_translate("MainWindow", "SAFE TO APPROACH"))
