...
int main(void)
{
  ...
  // enabling the required interrupts by setting bits
...
// Three callbacks for the TX mailboxes (we do not know which mailbox is
// selected to send message - decided by the CAN scheduler
/**
